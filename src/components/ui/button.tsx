...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-md font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default:
          'bg-oz-purple text-primary-foreground hover:bg-oz-purple-deep active:bg-oz-purple-dark',
        destructive:
        ...
        ghost:
          'active:bg-oz-purple-light active:text-oz-purple hover:bg-oz-gray-white hover:text-oz-gray-dark text-oz-gray-dark dark:hover:bg-accent/50',
        ghost_purple_light:
          'hover:bg-oz-purple-light hover:text-oz-purple active:bg-oz-purple-medium active:text-oz-purple',
        ghost_purple: 'bg-oz-purple-light text-oz-purple',
        link: 'text-primary underline-offset-4 hover:underline',
      },
      size: {
        default: 'px-9 py-3 has-[>svg]:px-3',
